...
#include "basic_opencv/HueConfig.h"
...
void reconfigure_callback(basic_opencv::HueConfig &config, uint32_t level)
{
  if (first_reconfig)
  {
...
int main(int argc, char **argv)
{
  ...
  dynamic_reconfigure::Server<basic_opencv::HueConfig> config_server;
  dynamic_reconfigure::Server<basic_opencv::HueConfig>::CallbackType f;
